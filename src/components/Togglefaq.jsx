...
<div className="question flex w-screen px-20 justify-between items-center " onClick={toggleOpen}>
<span>{question}</span>
<div>
...
{isOpen && <div className="answer text-gray-400 mb-4  mx-20">{answer}</div>}
</div>
);
};
...
const FAQList = () => {
return (
<div className="faq-list  h-full flex justify-center">
<div>
<FAQToggle
